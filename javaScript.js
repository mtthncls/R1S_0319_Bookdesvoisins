      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <p class="card-text"><a href="${resids[i].corporationLink}" class="btn btn-secondary btn-lg active" style="background-color: white; border-color: rgb(0, 203, 179); color:rgb(0, 203, 179); position: relative; left: 25%;" role="button" aria-pressed="true">Site entreprise</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title police" style="font-size:25px">${resids[i].corporation}</h5>
              <p class="card-text">${resids[i].corporationPresentation}</p>
              <p class="card-text"><a href="${resids[i].corporationLink}" class="btn btn-secondary btn-lg active" style="background-color: white; border-color: rgb(0, 203, 179); color:rgb(0, 203, 179); position: relative; left: 25%;" role="button" aria-pressed="true">Site entreprise</a>
            </div>
          </div>
        </div>
      </div>
